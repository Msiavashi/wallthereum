            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-timeline5">
                        <div class="timeline">
                            <div class="timeline-icon"><span class="year">Create</span></div>
                        ...
                        <div class="timeline">
                            <div class="timeline-icon"><span class="year">Store</span></div>
                            <div class="timeline-content">
                        ...
                        <div class="timeline">
                            <div class="timeline-icon"><span class="year">Connect</span></div>
                            <div class="timeline-content">
                                <h3 class="title">Web Desginer</h3>
                                <p class="description">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lacinia mi ultrices, luctus nunc ut, commodo enim. Vivamus sem erat.
                        ...
                        <div class="timeline">
                            <div class="timeline-icon"><span class="year">Trade</span></div>
                            <div class="timeline-content">
                                <h3 class="title">Web Developer</h3>
                                <p class="description">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lacinia mi ultrices, luctus nunc ut, commodo enim. Vivamus sem erat.
